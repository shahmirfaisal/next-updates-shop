  ...
  return (
    <Layout categories={props.categories}>
      <Head>
        ...
        <meta
          property="og:title"
          content="Terms and Conditions - Updates Shop"
          key="ogtitle"
        />
        <meta
      ...
      <Container maxWidth="lg" style={{ marginTop: "2rem" }}>
        ...
        <p>Welcome to Updates Shop!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Updates Shop's Website, located at https://updatesshop.com/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Updates Shop if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing Updates Shop, you agreed to
          use cookies in agreement with the Updates Shop's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Updates Shop and/or its licensors own the
          intellectual property rights for all material on Updates Shop. All
          intellectual property rights are reserved. You may access this from
          Updates Shop for your own personal use subjected to restrictions set
          in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Updates Shop</li>
          <li>Sell, rent or sub-license material from Updates Shop</li>
          <li>Reproduce, duplicate or copy material from Updates Shop</li>
          <li>Redistribute content from Updates Shop</li>
        </ul>
        ...
        <p>
          ...
          Updates Shop does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Updates Shop,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Updates Shop
        ...
        <p>
          Updates Shop reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant Updates Shop a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Updates Shop; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Updates Shop. Please include your name, your
        ...
        <p>
          No use of Updates Shop's logo or other artwork will be allowed for
